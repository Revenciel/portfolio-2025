...
import featuresSection from '@/public/images/red-hat-product-pages/features-section.webp'
import featuresVariations from '@/public/images/red-hat-product-pages/features-variations.webp'
import productHeroes from '@/public/images/red-hat-product-pages/product-heroes.webp'
import template from '@/public/images/red-hat-product-pages/template.webp'
import productList from '@/public/images/red-hat-product-pages/product-list.webp'
...
<section className='summary-card'>
    <div className='wrapper'>
        ...
        <div className='summary-card'>
            <div>
                <h3>Challenge</h3>                    <p>Red Hat's complex and extensive product portfolio lacked consistent, clear design patterns for its product pages. Customers often struggled to distinguish between similar offerings, slowing decision-making and risking abandonment.</p>
            </div>
            <div>
                <h3>Approach</h3>
                <p>I designed scalable, templated product pages informed by heat map data and past UX research studies. I standardized high-performing patterns and provided guidelines for content, as well as created new hero patterns to differentiate between product types.</p>
            </div>
            <div>
                <h3>Outcomes</h3>
                <ul>
                    ...
                    <li>Visual cues helped customers quickly distinguish different types of product pages, reducing confusion and streamlining their product search.</li>
                </ul>
            </div>
        </div>
...
<Section theme='alt'>
    ...
    Based on this data, I chose two pattern options to pull into the product page template, and provided guidelines and recommendations for their use, including content themes and word-count recommendations.
    ...
    I expanded on the [Red Hat design system system](https://ux.redhat.com/), introducing new hero options for product pages, including variations for stand-alone products, product families, and products within a family or bundle. These distinctions would help customers quickly orient themselves without needing to read deeply into the page content.
